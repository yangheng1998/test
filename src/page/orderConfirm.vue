          ...
          <div class="item-good">
            ...
            <ul>
              <li v-for="(item,index) in cartList" :key="index">
                <div class="good-name">
                  <img v-lazy="item.productMainImage" alt="404">
  ...
  methods:{
    ...
    getCartList(){
      this.axios.get('/carts').then((res)=>{
          ...
          this.cartTotalPrice=res.cartTotalPrice   // 购物车中已经选中商品总金额
          this.cartList=list.filter(item=>item.productSelected)   //返回的布尔值
    ...
    submitAddress(){
        ...
        if(userAction == 0 || userAction ==1){
            ...
            if(!receiverName){
                ...
                errmsg='请选择省份'
            }else if(!receiverCity || !receiverAddress){
                errmsg='请选择对应的城市'
